# D:/Documents/Poste_UN/Projet_Automatisation/onu_rdc_dashboard/ui/reset_ui_stable_ascii.R
...
writeLines(app_txt, app_path, useBytes = TRUE)
cat("ECRIT (stable ASCII):", app_path, "\n")
